 ...
 * given a 2D integer array factory where factory[j] = [positionj, limitj] indicates
 * that positionj is the position of the jth factory and that the jth factory
 * can repair at most limitj robots.
 *
 ...
 * a robot reaches a factory that did not reach its limit, the factory repairs the
 ...
 *    - The first robot at position 0 moves in the positive direction. It will
 *      be repaired at the first factory.
 *    - The second robot at position 4 moves in the negative direction. It will
 *      be repaired at the first factory.
